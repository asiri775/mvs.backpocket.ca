...
class VendorOrdersController extends Controller
{
    ...
    public function index()
    {
        ...
        if(isset($_GET['orderForm'])){
            ...
            OrderedProducts::select('orders.status AS order_status','ordered_products.created_at AS order_created_at','clients.*','ordered_products.orderid')->where('ordered_products.vendorid',Auth::user()->id)->orderBy('ordered_products.id','desc')
