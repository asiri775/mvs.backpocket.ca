...
//            ->whereIn('email_subjects.token',['Rwnup5tt', 'ZpBz6RGv', 'DhJr5fPO'])
//            ->get();
...
//        return response()->json([$order_status_mails]);
        ...
        return view('admin.orderlist',compact('orders'), compact('order_status_mails','customer_array','vendors','client_types','zones','order_status_array'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.orderdetails',compact('order','products','cus_details'));
    }
