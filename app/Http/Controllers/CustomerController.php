...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.customers', compact('customers', 'vendors', 'client_types', 'zones','customer_array'));
    }
    ...
    public function getCustomerSearchResults()
    {
        ...
        return view('admin.customers', compact('customers', 'status', 'clientType', 'zone', 'city', 'store', 'vendors', 'client_types', 'zones', 'customer_array'));
    }
