                        ...
                        <div class="col-xs-9">
                            <div class="tab-content">
                                <div class="tab-pane active" id="analytics">
                                    ...
                                    <form method="POST" action="{!! route('tools.update', $tools->id) !!}" class="form-horizontal form-label-left" novalidate>
                                        {{csrf_field()}}
                                ...
                                <div class="tab-pane" id="metatags">
                                    ...
                                    <div class="ln_solid"></div>
                                    <form method="POST" action="{!! route('tools.update', $tools->id ) !!}" id="meta_form" class="form-horizontal form-label-left" novalidate>
                                        {{csrf_field()}}
                                        <input type="hidden" name="_method" value="PATCH">
                                        <div class="item form-group">
