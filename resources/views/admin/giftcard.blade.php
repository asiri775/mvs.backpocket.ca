            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div id="response"></div>
                        @if($id === 'new')
                        <form method="POST" action="{!! route('gift-cards.store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        @else
                        <form method="POST" action="{!! route('gift-cards.update', $giftcard -> id ) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        @endif
