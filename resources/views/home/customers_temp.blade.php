...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('assets2/css/home/customers_temp.css') }}">
...
@endif
<section class="p-b-100 p-t-100" style="background-color: #EAEEE3">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="boxed no-padding">
                    <div class="inner">
                        <div id="wizard-form" class="wizard">
                            <ul class="steps">
                                <li data-target="step1" class="active"><span class="badge">1</span>Customer<span class="chevron"></span></li>
                                <li data-target="step2"><span class="badge">2</span>Products<span class="chevron"></span></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 basic-form" style="overflow: hidden;">
                                    <div class="customer_right_top" style="padding: 5px 10px 0 10px !important;margin: 30px 0 !important;">
                                        ...
                                        <p style="font-size: 15px">Use any one of the following filters to search for an existing client</p>
                                    </div>
                                    <div class="row">
