    ...
    <div class="container relative">
        <div class="pull-left">
            <div class="header-inner">
                <img src="{{ url('home_assets/images/logo.png') }}" width="152" height="30" data-src-retina="{{ url('home_assets/images/logo.png') }}" class="logo" alt="logo">
            </div>
        </div>
            ...
            <div class="pull-right">
                <div class="header-inner">
                    <ul class="menu">
                        ...
                        <li>
                            <a href="{{url('/home/customers')}}">Just Shred It</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="cont">LOGIN | 2 ITEMS | $0.00 &nbsp; <i class="fa fa-shopping-cart"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
