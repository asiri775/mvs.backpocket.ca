...
<link type="text/css" rel="stylesheet" href="{{ URL::asset('assets2/css/vendor/customer-details.css') }}">
    ...
    <script type="text/javascript" src="{{ URL::asset('assets2/js/customer-details.js') }}"></script>
