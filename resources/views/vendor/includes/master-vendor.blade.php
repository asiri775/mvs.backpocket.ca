...
<link type="text/css" rel="stylesheet" href="{{ URL::asset('assets2/css/vendor/include/master-vendor.css') }}">
	<script>
                     ...
                     <ul>
                        ...
                        <li class="simple-list"><a href="{!! url('vendor/dashboard') !!}" class="">Reports</a></li>
                         <li class="dropdown simple-list">
                             <a class="dropdown-toggle" data-toggle="dropdown" href="#">Repeat Jobs
                                 <span class="caret"></span></a>
                             <ul class="dropdown-menu">
                                 <li><a href="{!! url('vendor/order-template') !!}">Order Templates</a></li>
                             </ul>
                         </li>
                     </ul>
                     <div class="clear"></div>
