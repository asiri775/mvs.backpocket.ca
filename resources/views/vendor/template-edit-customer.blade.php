...
@section('content')
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets2/css/vendor/template-edit-customer.css') }}">
                    ...
                    <div class="address-form-block col-md-12 col-sm-12 col-xs-12 mt-2 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 mt-2">
                                ...
                                <div class="col-sm-4">
                                    <input class="w-100" type="text" name="name_for_sams" id="name_for_sams" placeholder="Name for SAMS" value="{{$orderTemplate->name_for_sams}}">
                                </div>
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="col-xs-12 mt-2">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="days_allowed[]" placeholder="Please Select" class="form-control custom-select" multiple id="days_allowed">
                                        <option value="1" <?php if($days_allowed[1]) {?>selected<?php }?>>Monday</option>
                                        <option value="2" <?php if($days_allowed[2]) {?>selected<?php }?>>Tuesday</option>
                                        <option value="3" <?php if($days_allowed[3]) {?>selected<?php }?>>Wednesday</option>
                                        <option value="4" <?php if($days_allowed[4]) {?>selected<?php }?>>Thursday</option>
                                        <option value="5" <?php if($days_allowed[5]) {?>selected<?php }?>>Friday</option>
                                        <option value="6" <?php if($days_allowed[6]) {?>selected<?php }?>>Saturday</option>
                                        <option value="7" <?php if($days_allowed[7]) {?>selected<?php }?>>Sunday</option>
                                    </select>
                            ...
                            <div class="col-xs-12 mt-2">
                                ...
                                <div class="col-sm-4">
                                    <input class="w-100" type="date" name="schedule_from" id="schedule_from" value="{{$orderTemplate->schedule_from}}">
                            ...
                            <div class="text-right col-xs-12 mt-2">
                                <div class="actions col-xs-7">
                                    <button type="submit" data-next="step2" id="btnCreateClient"
                                            class="btn btn-success btn-next">Update<i class="icon-arrow-right"></i>
                                    </button>
