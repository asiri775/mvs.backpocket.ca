					    ...
					    <div id="companySettings" class="tab-pane fade <?php if($activeMenu==1){echo 'in active';} ?>">
					     	<div class="bg-white">
								<div class="panel-body-custom tableContainParent">
									<form method="POST" action="{!! action('VendorProfileController@update',$vendor->id ) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
			                            {{csrf_field()}}
...
@section('footer')
<script src="{{ URL::asset('assets2/js/vemdorprofile.js') }}"></script>
@stop
